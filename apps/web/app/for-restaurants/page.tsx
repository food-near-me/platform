...
export default function ForRestaurantsPage() {
  return (
    <SiteShell variant="restaurants" crumb="restaurants">
      <HeroVariant />
      <DemandSignal />
        ...
        <div className="section-body full">
          <div className="card-grid">
            ...
            <article className="card">
              <h3>Market data</h3>
              <ul>
                <li>Near-me food intent is massive and recurring</li>
                <li>Agents need structured menus, not scraped PDFs</li>
                <li>20–30% extracted by legacy delivery apps</li>
                <li>Machine-readable listings are still rare</li>
              </ul>
            </article>
            <article className="card">
              <h3>Moat</h3>
              <ul>
                ...
                <li>Agent-native API + MCP</li>
                <li>Trust tiers: discovered → indexed → verified</li>
      ...
      <section className="section">
        ...
        <div className="section-body full">
          <div className="moat-grid">
            ...
            <div className="moat-cell">
              <p className="moat-tag">MCP</p>
              <h3>Native for agents</h3>
              <p>
                Plug into Claude, Cursor, and other MCP hosts without a custom
                API wrapper.
              </p>
            </div>
            <div className="moat-cell">
        ...
        <div className="section-body full">
          <div className="token-teaser">
            <div>
              ...
              <p>
                Optional financing model for long-term build-out — secondary to
